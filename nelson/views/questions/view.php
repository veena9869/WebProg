...
<div class="questionsview_box"><div class="questionsview_up<?php if($pvote) { echo " voteselected"; }?>" onclick="upvote(<?php echo $id;?>)">˄</div><div class="questionsview_vote"><?php echo $votes;?></div><div class="questionsview_down" <?php if($nvote) { echo "voteselected"; }?>>˅</div>
