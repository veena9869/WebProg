...
<input type="password" class="textbox" name="password" id="password" value=""/></select><br/>

<h3>Image <span style="font-size:10px">(Leave blank if you do not want to update)</span></h3>
<input type="hidden" name="MAX_FILE_SIZE" value="3000">
File: <input name="mkfile" type="file"><br/>
